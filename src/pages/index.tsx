...
export default function Home() {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center' style={{
      ...
      <div className='max-w-screen-2xl w-full flex flex-col items-center rounded-xl my-5 bg-gray-300 bg-opacity-80'>
        {relatorio?
        <div>
          ...
          <iframe className='rounded-2xl' title="Report Section" width="1536" height="900" src="https://app.powerbi.com/view?r=eyJrIjoiNzkzYzIzNWQtOGEyYi00NzBmLWJlMjktYWY5Y2ZiZTYwNTQ0IiwidCI6IjE0Y2JkNWE3LWVjOTQtNDZiYS1iMzE0LWNjMGZjOTcyYTE2MSIsImMiOjh9"></iframe>
